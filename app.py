...
from blueprints.characters import char_blueprint
from constants import WEB_DEBUG, DB_URI, SECRET_KEY, ADMIN_PASSWORD
from helpers.csp_helper import get_csp
...
app.register_blueprint(char_blueprint, url_prefix='/character_admin')

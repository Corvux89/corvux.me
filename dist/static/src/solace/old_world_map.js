...
const initMap = async () => {
    ...
    const createPanzoomController = (instance) => {
        ...
        syncZoomScale();
        mapStage.addEventListener("panzoomchange", clampPan);
        mapStage.addEventListener("panzoompan", clampPan);
        mapStage.addEventListener("panzoomzoom", clampPan);
        mapStage.addEventListener("panzoomend", clampPan);
        return {
            zoomIn: () => {
                if (instance.zoomIn) {
                    instance.zoomIn();

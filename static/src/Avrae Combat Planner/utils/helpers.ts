...
export function copyString(content: string, tooltipString: string, elementID: string) {
...
function createInputElement(id: string, label: string, value: string, type: string, max: string = null) {

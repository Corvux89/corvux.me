...
$('#guild-settings-save-button').on('click', function(){
    ...
    .then(guild => {
        ...
        guild.tier_2_role = Number($('#guild-tier-2-role').find(':selected').val())
        guild.tier_3_role = Number($('#guild-tier-3-role').find(':selected').val())
        guild.tier_4_role = Number($('#guild-tier-4-role').find(':selected').val())
        guild.tier_5_role = Number($('#guild-tier-5-role').find(':selected').val())
        guild.tier_6_role = Number($('#guild-tier-6-role').find(':selected').val())
